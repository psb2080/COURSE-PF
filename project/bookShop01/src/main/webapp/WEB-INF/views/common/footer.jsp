...
<ul class=" font-italic">
	<li><a href="#" data-toggle="modal" data-target="#agreementModal">이용약관</a></li>
	<li><a href="#">회사소개</a></li>
	<li><a href="#" style="color:red" data-toggle="modal" data-target="#privacyModal">개인정보취급방침</a></li>
	<li><a href="#" data-toggle="modal" data-target="#emailCollectingRefusalModal">이메일 집단 수집 거부</a></li>
	<li><a href="#" data-toggle="modal" data-target="#callcenter">고객만족센터</a></li>
	<li><a href="#" style="color:red">광고센터</a></li>
</ul>
<div class="clear"></div>
<a href="#"><img width="147px"  height="62px" alt="Booktopia" src="${contextPath}/resources/image/logo.png" /></a>
<div style="padding-left:200px">
	 ㈜STEP <br>
	 팀장 : 배성민   <br>
	 주소 : 하이미디어<br>  
	 사업자등록번호 : 104-52-342312 <br>
	 서울특별시 통신판매업신고번호 : 제 666호 ▶사업자정보확인   개인정보보호최고책임자 : 김길동 privacy@google.co.kr <br>
	 대표전화 : 1544-1544 (발신자 부담전화)   팩스 : 0502-977-7777 (지역번호공통) <br>
	 COPYRIGHT(C) STEP CENTRE ALL RIGHTS RESERVED.
</div>
...
제1조(목적)
이 약관은 (주)steplant(전자상거래 사업자)가 운영하는 (주)steplant 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.

※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」

제2조(정의)
①“몰” 이란 (주)steplant가 재화 또는 용역(이하 “재화등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
②“몰”과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.">
   ...
   <p> 회사는 회원가입, 상담, 서비스 신청 등등을 위해 아래와 같은 개인정보를 수집하고 있습니다.
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p class="font-size-14" style="line-height: 2em;">
                            steplant에 게시된 이메일주소를 전자우편 수집프로그램이나, <br>
                        ...
                        <!-- Modal -->
        <div class="modal fade" id="callcenter" tabindex="-1">
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header p-3">
                        <h5 class="modal-title" id="callModalLabel">고객센터 전화번호</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <p class="font-size-18" style="line-height: 2em;">
                            call : 010-3030-8184 <br>
