...
<form name="frm_mod_member">
	<h3> 회원 정보 관리</h3>
	<div id="detail_table" class="border-bottom-success">
		<table>
			<tbody>
				<tr class="dot_line">
					<td class="fixed_join">아이디</td>
					<td>
						<input style="width:200px"class="form-control" name="member_id" type="text" size="20" value="${memberInfo.member_id }"  disabled/>
					</td>
					 <td>
					</td>
				</tr>
				<tr class="dot_line">
					...
					<td>
					  <input style="width:200px"class="form-control" name="member_pw" type="password" size="20" value="${memberInfo.member_pw }" />
					</td>
					<td>
					  <input type="button" class="btn btn-outline-success" value="수정하기" onClick="fn_modify_member_info('member_pw')" />
					</td>
				</tr>
				<tr class="dot_line">
					<td class="fixed_join">이름</td>
					<td>
					  <input name="member_name" style="width:200px"class="form-control" type="text" size="20" value="${memberInfo.member_name }"  disabled />
					 </td>
					 <td>
					</td>
				</tr>
				<tr class="dot_line">
					...
					<td>
					  <input type="button" class="btn btn-outline-success" value="수정하기" onClick="fn_modify_member_info('member_gender')" />
					</td>
				</tr>
				<tr class="dot_line">
					...
					<td>
					  <input type="button" class="btn btn-outline-success" value="수정하기" onClick="fn_modify_member_info('member_birth')" />
					</td>
				</tr>
				<tr class="dot_line">
	                ...
	                <td>
	                    ...
	                    - <input class="pl-1" type="text" size=4  name="tel2" value="${memberInfo.tel2 }">
	                    - <input class="pl-1" type="text" size=4  name="tel3" value="${memberInfo.tel3 }">
	                </td>
	                <td>
	                  <input type="button" class="btn btn-outline-success" value="수정하기" onClick="fn_modify_member_info('tel')" />
	                </td>
				<tr class="dot_line">
					...
					<td>
					 ...
					 - <input class="pl-1" type="text" name="hp2" size=4 value="${memberInfo.hp2 }">
					 - <input class="pl-1" type="text"name="hp3"  size=4 value="${memberInfo.hp3 }"><br> <br>
					 <c:choose>
					...
					<td>
					  <input type="button" value="수정하기" class="btn btn-outline-success" onClick="fn_modify_member_info('hp')" />
					</td>
				</tr>
				<tr class="dot_line">
					<td class="fixed_join">이메일<br>(e-mail)</td>
					<td>
					   <input class="pl-1" type="text" name="email1" size=10 value="${memberInfo.email1 }" /> @ <input class="pl-3" type="text" size=10  name="email2" value="${memberInfo.email2 }" />
					...
					<td>
					  <input type="button" class="btn btn-outline-success" value="수정하기" onClick="fn_modify_member_info('email')" />
					</td>
				</tr>
				<tr class="dot_line">
					<td class="fixed_join">주소</td>
					<td>
					   <input class="pl-1 mb-3" type="text" id="zipcode" name="zipcode" size=5 value="${memberInfo.zipcode }" > <a href="javascript:execDaumPostcode()">우편번호검색</a>
					  <br>
					  <p>
					   지번 주소:<br><input class="form-control" style="width:350px" type="text" id="roadAddress"  name="roadAddress" size="50" value="${memberInfo.roadAddress }"><br><br>
					  도로명 주소: <input class="form-control" style="width:350px" type="text" id="jibunAddress" name="jibunAddress" size="50" value="${memberInfo.jibunAddress }"><br><br>
					  나머지 주소: <input class="form-control" style="width:350px" type="text"  name="namujiAddress" size="50" value="${memberInfo.namujiAddress }" />
					   </p>
					</td>
					<td>
					  <input type="button"  class="btn btn-outline-success" value="수정하기" onClick="fn_modify_member_info('address')" />
					</td>
				</tr>
			</tbody>
		</table>
		...
		<tr>
			<td >
				...
				<input name="btn_cancel_member" class="btn btn-outline-success" type="button"  value="수정 취소">
			</td>
		</tr>
	</table>
	</div>
