 ...
 //   $con = mysqli_connect("localhost", "gdkgate", "", "gdkgate") or die("MySqlDB 접속 실패 !!");
  ...
  /*
    ...
    */
    ...
    $statement = mysqli_prepare($con, "UPDATE t_shopping_member SET member_pw = ?, member_name=?, email1=?, email2=?, member_gender=?, hp1=?, hp2=?, hp3=? Where member_id=?");
    mysqli_stmt_bind_param($statement, "sssssssss", $member_pw,$member_name,$email1,$email2,$member_gender,$hp1,$hp2,$hp3,$member_id); // sssi는 string 3개 int 1개
